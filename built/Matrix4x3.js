...
var Matrix4x3 = /** @class */ (function () {
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.vector3Multiply = function (v, m) {
        return new Vector3_1.default(v.x * m.m11 + v.y * m.m21 + v.z * m.m31 + m.tx, v.x * m.m12 + v.y * m.m22 + v.z * m.m32 + m.tx, v.x * m.m13 + v.y * m.m23 + v.z * m.m33 + m.tx);
    };
    /**
     * 矩阵叉乘
     *
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.matrix4x3Multiply = function () {
        var args = [];
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.clearTranslation = function () {
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setTranslation = function (v) {
        this.tx = v.x;
        this.ty = v.y;
        this.tz = v.z;
    };
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setupTranslation = function (v) {
        this.identity();
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setupLocalToParentFromEulerAngle = function (pos, orientation) {
        var orientationMatrix = RotationMatrix_1.default.fromEulerAngle(orientation);
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setupLocalToParentFromRotationMatrix = function (pos, orientation) {
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setupParentToLocalFromEulerAngle = function (pos, orientation) {
        var orientationMatrix = RotationMatrix_1.default.fromEulerAngle(orientation);
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setupParentToLocalFromRotationMatrix = function (pos, orientation) {
        this.m11 = orientation.m11;
        this.m12 = orientation.m12;
        this.m13 = orientation.m13;
        this.m21 = orientation.m21;
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setupRotateFromXYZAxis = function (axis, theta) {
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setupRotateFromVector3 = function (axis, theta) {
        if (Math.abs(Vector3_1.default.getNorm(axis) - 1) > 0.01) {
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setupScale = function (v) {
        this.m11 = v.x;
        this.m12 = 0;
        this.m13 = 0;
        this.m21 = 0;
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setupScaleFromAxis = function (axis, k) {
        if (Math.abs(Vector3_1.default.getNorm(axis) - 1) > 0.01) {
            throw Error('旋转轴向量应为单位向量!');
        }
        var a = k - 1;
     ...
     * @memberof Matrix4x3
     */
    Matrix4x3.prototype.setupReflection = function (n) {
        if (Math.abs(Vector3_1.default.getNorm(n) - 1) > 0.01) {
